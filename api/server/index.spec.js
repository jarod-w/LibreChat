...
describe('Server Configuration', () => {
  ...
  beforeAll(() => {
    fs.readFileSync = function (filepath, options) {
      if (filepath.includes('index.html')) {
        return '<!DOCTYPE html><html><head><title>Nucleant</title></head><body><div id="root"></div></body></html>';
      }
  ...
  beforeAll(async () => {
    ...
    fs.writeFileSync(
      ...
      '<!DOCTYPE html><html><head><title>Nucleant</title></head><body><div id="root"></div></body></html>',
    );
