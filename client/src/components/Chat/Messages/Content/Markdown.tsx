...
import { langSubset, preprocessLaTeX, preprocessNucleantMarkers } from '~/utils';
...
const Markdown = memo(function Markdown({ content = '', isLatestMessage }: TContentProps) {
  ...
  const currentContent = useMemo(() => {
    ...
    const latexed = LaTeXParsing ? preprocessLaTeX(content) : content;
    return preprocessNucleantMarkers(latexed);
